...
# The main bot script now handles loading ini.py
# sys.path is modified to allow imports from other modules
sys.path.append(os.path.join(config.BOT_ROOT, "model"))
sys.path.append(os.path.join(config.BOT_ROOT, "controller"))
